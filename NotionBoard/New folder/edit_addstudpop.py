...
class Ui_edit_addstudpop(object):
    def setupUi(self, edit_addstudpop):
        edit_addstudpop.setObjectName("edit_addstudpop")
        edit_addstudpop.resize(544, 583)
        self.centralwidget = QtWidgets.QWidget(edit_addstudpop)
...
"")
        ...
        self.retranslateUi(edit_addstudpop)
        QtCore.QMetaObject.connectSlotsByName(edit_addstudpop)

    def retranslateUi(self, edit_addstudpop):
        _translate = QtCore.QCoreApplication.translate
        edit_addstudpop.setWindowTitle(_translate("edit_addstudpop", "Dialog"))
        self.addstud_btn.setText(_translate("edit_addstudpop", "Confirm"))
        self.tags_pinfo.setText(_translate("edit_addstudpop", "Edit-Student"))
        self.addstudback_btn.setText(_translate("edit_addstudpop", "Back"))
        self.studbirthdayedit.setPlaceholderText(_translate("edit_addstudpop", "What about their birthday?"))
        self.studgenderedit.setPlaceholderText(_translate("edit_addstudpop", "What\'s their email address?"))
        self.studnameedit.setPlaceholderText(_translate("edit_addstudpop", "What\'s the student name?"))
        self.label_3.setText(_translate("edit_addstudpop", "Name:"))
        self.label.setText(_translate("edit_addstudpop", "Email:"))
        self.label_2.setText(_translate("edit_addstudpop", "Birthday:"))
